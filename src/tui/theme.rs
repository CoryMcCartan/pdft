...
pub const COMMENT_HIGHLIGHT: Style = Style::new().bg(Color::Rgb(60, 60, 20));
pub const COMMENT_INFO: Style = Style::new().fg(Color::Yellow);
pub const COMMENT_PAGE: Style = Style::new().fg(Color::Yellow);
pub const FORM_FIELD: Style = Style::new().fg(Color::Green);
pub const FORM_FIELD_ACTIVE: Style = Style::new().fg(Color::LightGreen);
